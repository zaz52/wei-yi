...
const TWO_POINT_TWO_ELEVEN_CHANGELOG: ChangelogEntry = {
  ...
  highlights: {
    en: [
      ...
      "Fixed local CLI mode being overridden by preset default models; when no model is entered manually, WeiYi now reads the current default model from ~/.claude/settings.json and ~/.codex/config.toml and runs with the local CLI configuration first.",
      ...
      "Moved the updater channel to the WeiYi GitHub release feed so in-app updates install WeiYi builds instead of upstream builds.",
    ...
    zh: [
      ...
      "将软件内更新通道切换到唯一自己的 GitHub 发布源，避免更新时下载并安装上游原版。",
...
const TWO_POINT_ZERO_CHANGELOG: ChangelogEntry = {
  ...
  highlights: {
    en: [
      "Major release: upgraded 唯一 from a basic AI writing assistant into a staged novel-writing workflow with planning, generation, review, rewrite, and traceable revision loops.",
    ...
    zh: [
      "本次 2.0.0 是一次大型版本升级，唯一从普通 AI 辅助写作工具升级为更完整的小说创作工作流系统，覆盖规划、生成、审查、修改和可追踪返修。",
