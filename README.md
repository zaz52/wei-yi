<p align="center">
  <img src="QM-LOGO.png" width="120" alt="QMai Studio Logo" />
</p>

<h1 align="center">QMai Studio</h1>
...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.2.8-teal?style=flat-square" alt="Version" />
...
QMai Studio不是普通的 AI 聊天写作工具。它是一套**长篇小说记忆型写作系统**，专为 200 万～300 万字量级的连载小说创作设计。

核心理念：

> 写前自动提取上下文 → 写后自动沉淀章节记忆 → 图谱追踪关系变化 → 审查系统防止崩坏 → 人工确认最终定稿

普通 AI 写作工具的问题在于：写到后期 AI 会遗忘前文、人物性格不一致、时间线混乱、伏笔丢失。QMai Studio通过结构化记忆系统和混合检索引擎，让 AI 在每次生成时都能"记住"之前的一切。
...
记忆系统是QMai Studio的核心引擎。每章正式保存后，系统会自动执行**章节摄取**，将正文内容结构化为可检索、可追踪、可复用的记忆单元。
...
针对长篇 AI 写作的常见崩坏问题，QMai Studio提供系统性解决方案：
...
本机便携版已生成到 `E:\QMaiStudio\QMaiStudio.exe`。
...
- 本机便携版：`E:\QMaiStudio\QMaiStudio.exe`
- 源码目录：`E:\QMAI`
